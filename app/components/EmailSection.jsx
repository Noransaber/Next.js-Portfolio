    ...
    <section id='contact' className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
      ...
      <div className='z-10'>
        ...
        <div className='socials flex flex-row gap-2'>
          <Link href='https://github.com/Noransaber/'>
            <Image src={GithubIcon} alt='Github Icon' width={30} height={30} className='mr-5' />
          </Link>
          <Link href='https://www.linkedin.com/in/noran-saber-abdelfattah-6198471ba/'>{/* <Image src={LinkedinIcon} alt='Linkedin Icon' width={30} height={30} /> */}</Link>
        </div>
      </div>
      <div>
        <form className='flex flex-col' onSubmit={handleSubmit}>
          <div className='mb-6'>
            ...
            <input name='email' type='email' id='email' required className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5' placeholder='exmaple@gmail.com' />
          </div>
          <div className='mb-6'>
